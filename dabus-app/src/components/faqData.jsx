...
const FAQ_SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: (
          <>
            Open a stop's arrivals and tap{" "}
            <code>
            <svg
              width="13"
              height="13"
              ...
              aria-hidden="true"
              style={{ verticalAlign: "-2px", marginRight: "3px" }}
            >
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
            Add to Favorites
            </code>
            . You can give it a custom name like Home or Work,
            and it will show up in the Favorites tab.
          </>
        ),
      },
      {
